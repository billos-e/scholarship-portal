...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "node:path": path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      "node:stream": path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      "node:crypto": path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      ...
      "node:os": path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      "fs/promises": path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      fs: path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      os: path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      stream: path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
      crypto: path.resolve(import.meta.dirname, "src/shims/node-stub.ts"),
