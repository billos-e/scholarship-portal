...
export const semesterReports = pgTable(
  "semester_reports",
  {
    ...
    receivedAcademicExcellenceAward: boolean(
      "received_academic_excellence_award",
    ),
    receivedOtherAward: boolean("received_other_award"),
    awardFileUrls: text("award_file_urls").array(),
    awardsComment: text("awards_comment"),
    ...
    activitiesComment: text("activities_comment"),
